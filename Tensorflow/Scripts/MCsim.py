...
def MCsim(net,Xtest,Ytest,M,Wstd,Bstd,force,net_name="Network",custom_objects=None,optimizer=tf.keras.optimizers.SGD(learning_rate=0.1,momentum=0.9),loss=['sparse_categorical_crossentropy'],metrics=['accuracy']):
