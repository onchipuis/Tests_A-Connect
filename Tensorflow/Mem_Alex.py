...
def memory_test(Wstd,Bstd):
    model = tf.keras.models.Sequential([
		...
		ConvAConnect.ConvAConnect(filters=96, kernel_size=(11,11),Wstd=Wstd,Bstd=Bstd, strides=4,padding="VALID",pool=4,d_type=tf.dtypes.float16),
		tf.keras.layers.BatchNormalization(),        
        tf.keras.layers.ReLU(),
		tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
		#ConvAConnect.ConvAConnect(filters=256, kernel_size=(5,5), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=1,Slice=1,d_type=tf.dtypes.float16),
		#tf.keras.layers.BatchNormalization(),        
        #tf.keras.layers.ReLU(),
		#tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
		...
		#tf.keras.layers.BatchNormalization(),        
        #tf.keras.layers.ReLU(),
		#ConvAConnect.ConvAConnect(filters=384, kernel_size=(1,1), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
		#tf.keras.layers.BatchNormalization(),        
        #tf.keras.layers.ReLU(),
		#ConvAConnect.ConvAConnect(filters=256, kernel_size=(1,1), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
		#tf.keras.layers.BatchNormalization(),        
        #tf.keras.layers.ReLU(),
		#tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
        ...
        #tf.keras.layers.ReLU(),
		#tf.keras.layers.Dropout(0.5),
		AConnect.AConnect(10, Wstd=Wstd,Bstd=Bstd,d_type=tf.dtypes.float16),
