...
def memory_test(Wstd,Bstd):
    ...
    model = tf.keras.models.Sequential([
		...
		ConvAConnect.ConvAConnect(filters=14, kernel_size=(11,11),Wstd=Wstd,Bstd=Bstd, strides=4,padding="VALID",Op=2,Slice=1,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
		tf.keras.layers.BatchNormalization(),
		tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
		ConvAConnect.ConvAConnect(filters=36, kernel_size=(5,5), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
		tf.keras.layers.BatchNormalization(),
		tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
		ConvAConnect.ConvAConnect(filters=54, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
		tf.keras.layers.BatchNormalization(),
		ConvAConnect.ConvAConnect(filters=54, kernel_size=(1,1), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
		tf.keras.layers.BatchNormalization(),
		ConvAConnect.ConvAConnect(filters=36, kernel_size=(1,1), Wstd=Wstd,Bstd=Bstd, strides=1,padding="SAME",Op=2,Slice=1,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
		tf.keras.layers.BatchNormalization(),
		tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2)),
		tf.keras.layers.Flatten(),
		AConnect.AConnect(256, Wstd=Wstd,Bstd=Bstd,pool=128,d_type=tf.dtypes.float16),
        tf.keras.layers.ReLU(),
