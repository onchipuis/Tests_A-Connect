	...
	if(not(isAConnect)):
      ...
      #tf.keras.layers.experimental.preprocessing.Rescaling(1./255),
		...
		model = tf.keras.models.Sequential([
            ...
            layers.Conv_AConnect(filters=64, kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=4, strides=1,padding="SAME",Op=1,Slice=1),
            tf.keras.layers.BatchNormalization(),            
            ...
            tf.keras.layers.ReLU(),
		        #tf.keras.layers.BatchNormalization(), 
            tf.keras.layers.MaxPool2D(pool_size=(2,2), strides=(2,2),padding="SAME"),
            layers.Conv_AConnect(filters=128, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd, isBin='yes',pool=4,strides=1,padding="SAME",Op=1,Slice=1),
	          tf.keras.layers.BatchNormalization(),
            tf.keras.layers.ReLU(),
	          #tf.keras.layers.BatchNormalization(), 
			layers.Conv_AConnect(filters=128, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes', pool=4,strides=1,padding="SAME",Op=1,Slice=1),
            ...
            tf.keras.layers.ReLU(),
	          #tf.keras.layers.BatchNormalization(), 
            tf.keras.layers.MaxPool2D(pool_size=(2,2), strides=(2,2),padding="SAME"),
            layers.Conv_AConnect(filters=256, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=4, strides=1,padding="SAME",Op=1,Slice=1),
            tf.keras.layers.BatchNormalization(),
            tf.keras.layers.ReLU(),
            #tf.keras.layers.BatchNormalization(), 
            layers.Conv_AConnect(filters=256, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=4, strides=1,padding="SAME",Op=1,Slice=1),
		    ...
		    layers.Conv_AConnect(filters=512, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes', pool=4,strides=1,padding="SAME",Op=1,Slice=1),
            tf.keras.layers.BatchNormalization(),
            tf.keras.layers.ReLU(),
            #tf.keras.layers.BatchNormalization(), 
            layers.Conv_AConnect(filters=512, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=4, strides=1,padding="SAME",Op=1,Slice=1),
            ...
            #tf.keras.layers.BatchNormalization(), 
            tf.keras.layers.MaxPool2D(pool_size=(3,3), strides=(2,2),padding="SAME"),
            layers.Conv_AConnect(filters=512, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=4, strides=1,padding="SAME",Op=2,Slice=1),
            tf.keras.layers.BatchNormalization(),
            tf.keras.layers.ReLU(),
            #tf.keras.layers.BatchNormalization(), 
            layers.Conv_AConnect(filters=512, kernel_size=(3,3), Wstd=Wstd,Bstd=Bstd,isBin='yes', pool=4,strides=1,padding="SAME",Op=2,Slice=1),
            ...
            tf.keras.layers.Flatten(),
            tf.keras.layers.Dropout(0.1),
            layers.FC_AConnect(256, Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=16),
            tf.keras.layers.BatchNormalization(),
            tf.keras.layers.ReLU(),
            #tf.keras.layers.BatchNormalization(), 
            tf.keras.layers.Dropout(0.1),
            layers.FC_AConnect(10, Wstd=Wstd,Bstd=Bstd,isBin='yes',pool=16),
...
model=model_creation(isAConnect=True,Wstd=0.7,Bstd=0.7)
#parametros para el entrenamiento
model.compile(loss='sparse_categorical_crossentropy', optimizer=tf.optimizers.SGD(lr=0.001, momentum=0.9), metrics=['accuracy',top5],top5=True)
#### THIS TIME WE DIDN'T USE PRETRAINED WEIGHTS BECAUSE THE MODEL NEEDS A PRETRAINED BINARIZED WEIGHTS
"""
#sinAconnect
...
model.save("./Models/CifarVGG_Aconnect03bin.h5",include_optimizer=True)
