"""
First script to make the training for a simple one-hidden-layer neural network using different MNIST datasets. This network
can be trained using no regularization techniques, dropout, dropconnect (not working), and A-Connect.

Also you can test a convolutional neural network with this script using or not using A-Connect
"""
import tensorflow as tf
import numpy as np
from Networks import MNIST_mismatch			#Load the models
#from Scripts import customTraining
#from Scripts import ACModel
#from ACModel import ACModel
from Scripts import load_ds				#Load an script to modify the dataset
#from customTraining import CustomModel
from Layers import fullyconnected
import aconnect.layers as layers			#Load the layers from the library
import mylib as my
import datetime
