...
def model_creation(isAConnect=False,Wstd=0,Bstd=0,
        ...
        if(not(isAConnect)):
                ...
                model = tf.keras.models.Sequential([
                        ...
                        #RandomRotation(0.1),
                        RandomZoom(0.2),
                        Conv_AConnect(filters=64,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        Conv_AConnect(filters=64,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        MaxPool2D(pool_size=(2,2),strides=(2,2),padding="SAME"),
                        Conv_AConnect(filters=128,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        Conv_AConnect(filters=128,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        MaxPool2D(pool_size=(2,2),strides=(2,2),padding="SAME"),
                        Conv_AConnect(filters=256,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        Conv_AConnect(filters=256,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ...
                        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ...
                        ReLU(),
                        MaxPool2D(pool_size=(3,3),strides=(2,2),padding="SAME"),
                        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",Op=2,isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",Op=2,isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ...
                        Flatten(),
                        #Dropout(0.1),
                        FC_AConnect(256,Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=FC_pool,isBin=isBin),#isQuant=isQuant,bw=bw),
                        BatchNormalization(),
                        ReLU(),
                        #Dropout(0.1),
                        FC_AConnect(10,Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=FC_pool,isBin=isBin),#isQuant=isQuant,bw=bw),
                        Softmax()
            ])
