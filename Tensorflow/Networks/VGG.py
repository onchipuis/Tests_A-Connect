...
from .aconnect.aconnect.layers import Conv_AConnect, FC_AConnect 
		...
		model = tf.keras.models.Sequential([
			...
			#tf.keras.layers.UpSampling2D(),          
		        ...
		        BatchNormalization(),
                        ReLU(),
		        MaxPool2D(pool_size=(2,2),strides=(2,2),padding="SAME"),
		        Conv_AConnect(filters=128,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
                        ReLU(),
		        Conv_AConnect(filters=128,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
                        ReLU(),
		        MaxPool2D(pool_size=(2,2),strides=(2,2),padding="SAME"),
			Conv_AConnect(filters=256,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
                        ReLU(),
		        Conv_AConnect(filters=256,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
		        ...
		        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
                        ReLU(),
		        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",d_type=tf.dtypes.float16),
		        BatchNormalization(),
		        ...
		        BatchNormalization(),
                        ReLU(),
		        MaxPool2D(pool_size=(3,3),strides=(2,2),padding="SAME"),
		        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",Op=2,d_type=tf.dtypes.float16),
		        BatchNormalization(),
                        ReLU(),
		        Conv_AConnect(filters=512,kernel_size=(3,3),Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=Conv_pool,padding="SAME",Op=2,d_type=tf.dtypes.float16),
		        BatchNormalization(),
		        ...
		        Flatten(),
		        #Dropout(0.1),
		        FC_AConnect(256,Wstd=Wstd,Bstd=Bstd,errDistr=errDistr,pool=FC_pool,d_type=tf.dtypes.float16),
                        BatchNormalization(),
                        ReLU(),
		        #Dropout(0.1),
