...
# Without Aconnect
model.layers[1].set_weights(model_aux.layers[2].get_weights())
model.layers[2].set_weights(model_aux.layers[3].get_weights())
model.layers[4].set_weights(model_aux.layers[4].get_weights())
model.layers[7].set_weights(model_aux.layers[6].get_weights())
model.layers[9].set_weights(model_aux.layers[7].get_weights())
model.layers[12].set_weights(model_aux.layers[9].get_weights())
model.layers[14].set_weights(model_aux.layers[10].get_weights())
model.layers[16].set_weights(model_aux.layers[11].get_weights())
model.layers[19].set_weights(model_aux.layers[13].get_weights())
model.layers[21].set_weights(model_aux.layers[14].get_weights())
model.layers[23].set_weights(model_aux.layers[15].get_weights())
model.layers[26].set_weights(model_aux.layers[17].get_weights())
model.layers[28].set_weights(model_aux.layers[18].get_weights())
model.layers[30].set_weights(model_aux.layers[19].get_weights())
