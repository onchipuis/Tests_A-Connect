        ...
        for j in range(len(Wstd_aux)):
            for k in range(len(errDistr)):
                ...
                if isAConnect[d]:
                    ...
                    model.layers[4].set_weights(model_aux.layers[1].get_weights())
                    model.layers[6].set_weights(model_aux.layers[2].get_weights())
                    model.layers[9].set_weights(model_aux.layers[4].get_weights())
                    model.layers[11].set_weights(model_aux.layers[5].get_weights())
                    model.layers[14].set_weights(model_aux.layers[7].get_weights())
                    model.layers[16].set_weights(model_aux.layers[8].get_weights())
                    model.layers[18].set_weights(model_aux.layers[9].get_weights())
                    model.layers[21].set_weights(model_aux.layers[11].get_weights())
                    model.layers[23].set_weights(model_aux.layers[12].get_weights())
                    model.layers[25].set_weights(model_aux.layers[13].get_weights())
                    model.layers[28].set_weights(model_aux.layers[15].get_weights())
                    model.layers[30].set_weights(model_aux.layers[16].get_weights())
                    model.layers[32].set_weights(model_aux.layers[17].get_weights())
