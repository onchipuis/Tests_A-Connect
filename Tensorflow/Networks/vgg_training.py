...
# Without Aconnect
model.layers[0].set_weights(model_aux.layers[1].get_weights())
model.layers[2].set_weights(model_aux.layers[2].get_weights())
model.layers[5].set_weights(model_aux.layers[4].get_weights())
model.layers[7].set_weights(model_aux.layers[5].get_weights())
model.layers[10].set_weights(model_aux.layers[7].get_weights())
model.layers[12].set_weights(model_aux.layers[8].get_weights())
model.layers[14].set_weights(model_aux.layers[9].get_weights())
model.layers[17].set_weights(model_aux.layers[11].get_weights())
